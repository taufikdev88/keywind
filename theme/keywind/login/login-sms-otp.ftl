  ...
  <#elseif section = "form">
    <@form.kw action=url.loginAction method="post">
      <div
        ...
        data-token-code-type="otp-code"
        data-attempted-phone-number="${attemptedPhoneNumber}"
        data-init-send="${initSend?c}"
        data-init-send-expires="${expires}">
        ...
        <input type="hidden" x-model="phoneNumber" />
